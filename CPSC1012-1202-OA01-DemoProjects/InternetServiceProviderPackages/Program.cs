 ...
 *          C           $19.95/month
 *          
 * Output:  Total cost for a chosen Internet package.
 * 
 * */
...
namespace InternetServiceProviderPackages
{
    class Program
    {
        ...
        {
            // Declare variable for package letter (char) and billing cost (string)
            char packageLetter;
            string billingCost;
                ...
                case 'A':   // Package A
                    {
                        ...
                        billingCost = $"Package A total cost is {totalCost}";
                    }
                    break;
                case 'B':   // Package B
                    {
